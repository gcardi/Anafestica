...
The current library version includes serializers for Windows Registry and JSON files. In future versions will be possible to store data in XML files too. 
