//---------------------------------------------------------------------------
// TConfig roundtrip tests for all four backends (Registry, JSON, INIFile, XML)
// covering all 19 types in TConfigNodeValueType (bcc32c/boost::variant path).
// std::string and std::wstring are not variant alternatives on bcc32c, so the
// three test cases per backend that exercise those types are omitted here.
//---------------------------------------------------------------------------
