//---------------------------------------------------------------------------
// bcc64 compatibility-focused regression tests.
//---------------------------------------------------------------------------
...
BOOST_AUTO_TEST_SUITE( test_bcc64_compat )
...
#else
    BOOST_TEST_MESSAGE( "This suite targets legacy bcc64 only; skipping content." );
    BOOST_TEST( true );
#endif
}
