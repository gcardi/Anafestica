//---------------------------------------------------------------------------
// bcc64 compatibility-focused config tests (simplified for boost::variant).
// This file tests Registry/JSON/XML/INI backends with types supported by
// boost::variant (no std::string/wstring support in bcc64).
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// *** Registry::TConfig basic roundtrip tests (bcc64 compatible) ***
//---------------------------------------------------------------------------
