//---------------------------------------------------------------------------
// bcc64x simplified config tests for the shared-type subset.
// This file keeps the 19 roundtrip checks common to all three toolchains,
// while the bcc64x-only std::string/std::wstring coverage stays in
// test_config.cpp.
//---------------------------------------------------------------------------
